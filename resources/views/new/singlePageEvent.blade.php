                    ...
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-8 text-center" style="color: black;">
                            <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                                ...
                                <li><a style="color: black;" href="{{ Route('credibility') }}">credibility</a></li>
            ...
            <div class="row g-5 justify-content-between">
                <div class="col-lg-7 has-bg" data-aos="fade-right">
                    ...
                    <div>
                        ...
                        <h5 style=" font-weight: normal;">{{ $event->description }}</h5>
                    </div>
                    ...
                    <div>
                        ...
                        <h5 style=" font-weight: normal;">{{ $event->address }}</h5>
                    </div>

                </div>
                <div class="col-lg-4 align-self-center" data-aos="fade-left" data-aos-delay="100"
                    style="margin-bottom: 180px">
                    <h5 class="heading mb-4" style="color: rgb(79, 121, 95)">{{ $event->name }}</h5>
                    ...
                    <div
                        ...
                        <h5 class="beneficiary">{{ $event->beneficiary }} </h5>
                    ...
                    <div
                        ...
                        <h4 style="color: rgb(79, 121, 95); font-weight: normal;">
                            <i class="fa fa-user-circle-o"
                                style="margin-right: 5px;font-size:36px;color:rgb(79, 121, 95)"></i> total volunteers
                        </h4>
                        <h5 class="beneficiary">{{ $totalvolunteers }} </h5>
                    ...
                    <div
                        ...
                        <h4 style="color: rgb(79, 121, 95); font-weight: normal;">
                            <i class='fas fa-calendar-alt'
                                style="margin-right: 5px;font-size:36px;color:rgb(79, 121, 95)"></i> Date
                        </h4>
                        <h5 class="beneficiary">{{ $event->date }}</h5>

                    </div>

                    <br> <br>
                    @if ($volunteer->where('user_id', auth()->id())->isEmpty())
                    <form action="{{ route('volunteerr.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="event_id" value="{{ $event->id }}">
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary">Volunteering</button>
                    </form>
                @else
                    <h3>You are already a volunteer</h3>
                @endif
